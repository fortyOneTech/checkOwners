...
checkowners/
  ...
  github.py         # GitHub API: email->@handle mapping, team resolution,
                    # per-path PR-review coverage (review-activity factor)
...
- Default exclusions: `*.lock`, `dist/**`, `vendor/**`, `node_modules/**`, `*.generated.*`
