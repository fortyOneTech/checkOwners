...
The composite action also accepts `fail_on_drift: "false"` if you want to comment without blocking, and `include_bus_factor` / `include_decay` toggles for the secondary outputs.
